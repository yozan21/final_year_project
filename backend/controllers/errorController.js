...
export default async (err, req, res, next) => {
  ...
  //rollback if thumbnail uploaded
  if (req.rollbackThumbnail) {
    await req.rollbackThumbnail();
  }

  // rollback images if uploaded
  if (req.rollbackImages) {
    await req.rollbackImages();
  }
